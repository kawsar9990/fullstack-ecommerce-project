...
<div className="flex flex-col lg:flex-row lg:justify-center lg:items-center lg:gap-7">
    <div className="text-[25px] items-center uppercase flex flex-row justify-center font-semibold gap-5">
        <code className="text-[45px]"><FontAwesomeIcon icon={faTruck} /></code>
        <code>free shiping</code>
    </div>
    <code className="font-sans text-gray-700">Free Delivery Now On Your First Oder and over $300</code>

    <code className="text-2xl font-black">- Only $300*</code>
</div>
</div>
