...
import tshirt from '../../../assets/item/d3.png';
import iphone from '../../../assets/item/e5.png';
import shari from '../../../assets/item/pngwing.com.png';


import watch from '../../../assets/item/—Pngtree—black smartwatch with colorful display_23258636.png'
import shos from '../../../assets/item/68e67c8e585f9.png'
...
{/* second full box */}
<div className='p-3 flex flex-col md:flex-row lg:flex-col md:items-center md:gap-3'>
...
<div className='flex w-full justify-between items-center'>
  <div className='w-1/2'>
    <img src={watch.src} alt="" className='w-30'/>
  </div>
  <div className='w-1/2'>
...
<div className='flex w-full justify-between items-center'>
  <div className='w-1/2'>
    <img src={shos.src} alt="" className='w-30'/>
  </div>
  <div className='w-1/2'>
    <div className='text-black font-semibold'>By The Men Smart England Watch</div>
    <div className='font-bold text-orange-600'>₹5000</div>
