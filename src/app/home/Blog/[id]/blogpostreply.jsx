...
import img from "../../../../assets/svg/5.jpg"
...
{/* comments box */}
 <section className="border border-gray-400 p-7 rounded-md">
 <div className="text-2xl pb-7 font-serif font-bold flex gap-2 items-center">
