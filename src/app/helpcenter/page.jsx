...
export default function HelpCenterPage() {
  ...
  const helpMessage = encodeURIComponent("Hi! I need some help from your support team.");
  ...
  const categories = [
    { icon: <ShoppingBag className="text-amber-500 w-8 h-8" />, title: "Orders & Delivery", desc: "Track your orders and view shipping updates." },
    { icon: <CreditCard className="text-amber-500 w-8 h-8" />, title: "Payments & Refunds", desc: "Manage payments, refunds, and billing issues." },
    { icon: <User className="text-amber-500 w-8 h-8" />, title: "Account Settings", desc: "Change password, email, and manage privacy." },
    { icon: <Lock className="text-amber-500 w-8 h-8" />, title: "Security & Privacy", desc: "Learn how to secure your account." },
    { icon: <RefreshCw className="text-amber-500 w-8 h-8" />, title: "Returns & Replacements", desc: "Initiate returns and learn our policies." },
    { icon: <Headphones className="text-amber-500 w-8 h-8" />, title: "Customer Support", desc: "Get in touch or start a live chat." },
    { icon: <Truck className="text-amber-500 w-8 h-8" />, title: "Shipping Information", desc: "Check delivery times and courier options." },
  ];

  const faqs = [
    { q: "How do I reset my password?", a: "Click on 'Forgot Password' and follow email instructions." },
    { q: "Can I cancel my order?", a: "Yes, within 2 hours before shipping." },
    { q: "How do I contact customer service?", a: "Visit Customer Support or start a live chat." },
    { q: "Where is my refund?", a: "Refunds are processed within 3–5 business days." },
  ];

  return (
    <div className="min-h-screen pt-40 bg-white text-gray-900 py-16 px-6 relative">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900">Help Center</h1>
        <p className="mt-3 text-gray-600 text-lg max-w-2xl mx-auto">
          Find answers or get in touch with our support team anytime.
        </p>
      </motion.div>
      ...
      >
        {feedback ? (
          <p className="text-amber-600 font-semibold">
            {feedback === "yes" ? "🎉 Thanks for your feedback!" : "Thanks! We’ll improve further."}
          </p>
        ) : (
          <>
            <h3 className="text-xl font-bold mb-3 text-gray-900">Was this page helpful?</h3>
        ...
        {showHelpBox && (
          ...
          >
            <h4 className="text-lg font-semibold mb-2 flex items-center gap-2 text-gray-900">
              <HelpCircle className="text-amber-500 w-5 h-5" /> Need Help?
            </h4>
            <p className="text-gray-700 mb-4">
              Do you need any help or assistance right now?
            </p>
