...
export default function TermsPage() {
  const handleAgree = () => {
    alert("Thank you! You have accepted our Terms & Conditions.");
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <section>
            ...
            <p>
              All payments must be completed securely. We reserve the right to
          ...
          <section>
            ...
            <p>
              We may update these terms from time to time. Please review this
