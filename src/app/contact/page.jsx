...
import img1 from '../../assets/images/1761483426275_banner.jpeg'
import img2 from '../../assets/icons/contact_icon.png'
import img3 from '../../assets/myimg/2.jpeg'
import { useState } from 'react'
import FsLightbox from 'fslightbox-react'

import dynamic from 'next/dynamic'
const Maps = dynamic(()=> import('../../features/Maps/maps'),{
     ssr: false,
})
...
className='relative'>
  ...
  <img src={img1.src} alt="" className='w-full h-screen'/>
...
<img src={img3.src} alt="" className='rounded-lg flex justify-center items-center'/>
</motion.div>
<FsLightbox  toggler={toggler1} sources={[img3.src]}/> 
