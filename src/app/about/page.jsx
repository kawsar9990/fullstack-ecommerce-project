...
<div className="relative">
    <video src="/video/55.mp4" 
     autoPlay muted  loop className="w-full"></video>
<div className="absolute text-white top-0 flex justify-center items-center w-full h-full">
 <div>
    <ReactTyped className="font-black text-[20px] md:text-5xl" strings={["HI, I'AM KAWSAR AHMED"]} typeSpeed={40} />
    <br />
    <ReactTyped
      strings={[
      ...
      className="capitalize md:text-3xl text-emerald-200 font-bold"
      typeSpeed={40}
      backSpeed={50}
      loop
    />
