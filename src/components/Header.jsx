...
<li className="flex flex-col">
 ...
 {sideDropdown === "electro" && (
          <div className="flex flex-col pl-5 pt-2">
            <Link href={``} className="p-2 hover:bg-blue-50 hover:rounded-lg transition-all duration-300">Mobile</Link>
            <Link href={``} className="p-2 hover:bg-blue-50 hover:rounded-lg transition-all duration-300">Leptop</Link>
            <Link href={``} className="p-2 hover:bg-blue-50 hover:rounded-lg transition-all duration-300">Smart Watch</Link>
          </div>
        )}
...
<li className="flex flex-col">
 ...
 {sideDropdown === "bag" && (
          <div className="flex flex-col pl-5 pt-2">
            <Link href={``} className="p-2 hover:bg-blue-50 hover:rounded-lg transition-all duration-300">Men Bags</Link>
            <Link href={``} className="p-2 hover:bg-blue-50 hover:rounded-lg transition-all duration-300">Women Bags</Link>
          </div>
        )}
...
<li className="flex flex-col">
 ...
 {sideDropdown === "footw" && (
          <div className="flex flex-col pl-5 pt-2">
            <Link href={``} className="p-2 hover:bg-blue-50 hover:rounded-lg transition-all duration-300">Men Footwear</Link>
            <Link href={``} className="p-2 hover:bg-blue-50 hover:rounded-lg transition-all duration-300">Women Footwear</Link>
          </div>
        )}
...
<Link  href={``} className="hover:text-red-500 cursor-pointer font-semibold">
Groceries
</Link>
...
<div className="w-full overflow-x-auto scrollbar-hide">
    <div className="flex flex-row justify-between p-2 gap-3">
     <Link href={`/`} className="hover:text-red-500 font-semibold  cursor-pointer">Home</Link>
     <Link href={``} className="hover:text-red-500 font-semibold  cursor-pointer">Fashion</Link>
     <Link href={``} className="hover:text-red-500 font-semibold  cursor-pointer">Electronics</Link>
     <Link href={``} className="hover:text-red-500 font-semibold  cursor-pointer">Bags</Link>
     <Link href={``} className="hover:text-red-500 font-semibold  cursor-pointer">Footwear</Link>
      <Link href={``} className="hover:text-red-500 font-semibold  cursor-pointer">Groceries</Link>
      <Link href={``} className="hover:text-red-500 font-semibold  cursor-pointer">Beauty</Link>
      <Link href={``} className="hover:text-red-500 font-semibold  cursor-pointer">Wellness</Link>
      <Link href={``} className="hover:text-red-500 font-semibold  cursor-pointer">Jewellery</Link>
